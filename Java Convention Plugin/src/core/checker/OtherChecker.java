...
public class OtherChecker implements IChecker, OtherCheckerConstants {
  ...
  {
        new String("IF_NotAllowElse;true"),
        new String("IF_MustUseBracket;true")
 ...
 */
  ...
  Token t;
    ...
    t = getToken(1);
    System.out.println(t.image + RuleType.IF_MustUseBracket.active + t.image.equals("{"));
    if (RuleType.IF_MustUseBracket.active && (!t.image.equals("{")))
    {
      warnings.add(new WarningOther(new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn), new String [ ]
      {
        "You need to use bracket in IF statement based on flag: IF_needBracket = true"
      }
      ));
    }
    Statement();
    ...
    case ELSE:
      ...
      if (RuleType.IF_NotAllowElse.active)
      {
        warnings.add(new WarningOther(new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn), new String [ ]
        {
          "Else is not allow based on flag: IF_allowElse = false"
        }
        ));
      }

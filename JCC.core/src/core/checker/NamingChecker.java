 ...
 */
public class NamingChecker implements IChecker, NamingCheckerConstants {
   /**
   ...
   static public final class NameChecking{
   ...
   public Vector<Warning> warnings = new Vector<Warning>();
  ...
  public static void main(String args[]) {
    NamingChecker parser;
    if (args.length == 0) {
      System.out.println("Java Parser Version 1.1:  Reading from standard input . . .");
      parser = new NamingChecker(System.in);
    } else if (args.length == 1) {
      System.out.println("Java Parser Version 1.1:  Reading from file " + args[0] + " . . .");
      try {
        parser = new NamingChecker(new java.io.FileInputStream(args[0]));
      ...
      System.out.println("         java NamingChecker < inputfile");
   ...
   level++;
    ...
    t = jj_consume_token(IDENTIFIER);
        if (!NameChecking.isGoodClassName(t.image)){
                if (isInterface)
                {
                        warnings.add(new WarningNaming(
                                new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                                new String[] {WarningNaming.INTERFACE, t.image, NameChecking.transformToGoodClassName(t.image)}));
                }
                else
                { warnings.add(new WarningNaming(
                        new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                        new String[] {WarningNaming.CLASS, t.image, NameChecking.transformToGoodClassName(t.image)}));
                }
        }
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LT:
  ...
  Token t;
    ...
    t = jj_consume_token(IDENTIFIER);
        if (!NameChecking.isGoodClassName(t.image)){
                warnings.add(new WarningNaming(
                        new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                        new String[] {WarningNaming.ENUM, t.image, NameChecking.transformToGoodClassName(t.image)}));
        }
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IMPLEMENTS:
      ...
      jj_consume_token(RBRACKET);
        ...
        if (!isFinal || !isField){
                if (!NameChecking.isGoodVariableName(t.image)){
                        warnings.add(new WarningNaming(
                        new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                        new String[] {isField?WarningNaming.FIELD:WarningNaming.VARIABLE, t.image, NameChecking.transformToGoodVariableName(t.image)}));
                }
        } else {
                if (!NameChecking.isGoodConstantName(t.image)){
                        warnings.add(new WarningNaming(
                        new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                        new String[] {WarningNaming.CONSTANT, t.image, NameChecking.transformToGoodConstantName(t.image)}));
                }
    }
   level--;
  }
 ...
 Token t;
    t = jj_consume_token(IDENTIFIER);
        if (!NameChecking.isGoodVariableName(t.image)){
                warnings.add(new WarningNaming(
                        new Position(t.beginLine, t.endLine, t.beginColumn, t.endColumn),
                        new String[] {WarningNaming.METHOD, t.image, NameChecking.transformToGoodVariableName(t.image)}));
        }
    FormalParameters();
    label_14:
    while (true) {
 ...
 */
  final public void RUNSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT &&
                    ((MyNamingToken)getToken(1)).realKind == RUNSIGNEDSHIFT) {
  ...
  final public void RSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT &&
                    ((MyNamingToken)getToken(1)).realKind == RSIGNEDSHIFT) {

...
public class IndentChecker implements IChecker, IndentCheckerConstants {
  ...
  final public void insert(String addition) throws ParseException {
     wrapLvl.insert(getToken(0).image,getToken(0).endColumn, getToken(0).beginLine,addition.length());
  }
      ...
      t = jj_consume_token(SPACES);
        ...
        }else
        {
          if(correctSpaces.equals("")){
                    ...
                    comparedSpaceProcess("", correctSpaces,0,0);
                }
        }
  }
  ...
  final public void comparedSpaceProcess(String comparedSpace,String correctSpace,int beginLine, int beginColumn) throws ParseException {
            ...
            hasNewline = false;
                ...
                if(comparedSpaces.length>0){
                    ...
                    if(BOF) lnNotConsidered ++;
                    //if(comparedSpaces)
            if(comparedSpaces.length-lnNotConsidered<correctSpaces.length){

                            Out("Warning: line "+ beginLine +": Should break into lines.\u005cn");
                    }
...
/* Annotation Types. */
 ...
 String indent ="\u005cn";
    if (jj_2_68(2147483647)) {
        ...
        //Out(getToken(1).image+"\n");
        l--;
        SpaChk(indent);
        l++;
    } else {
                for (int i = 0; i < l; i++) indent= indent.concat("    ");
                        if(s.equals("    ")) indent= indent.concat("    ");
      SpaChk(indent);
    }
  }

 ...
 */
public class CommentChecker implements IChecker, CommentCheckerConstants {
   /**
  ...
  public static void main(String args[]) {
    CommentChecker parser;
    if (args.length == 0) {
      System.out.println("Java Parser Version 1.1:  Reading from standard input . . .");
      parser = new CommentChecker(System.in);
    } else if (args.length == 1) {
      System.out.println("Java Parser Version 1.1:  Reading from file " + args[0] + " . . .");
      try {
        parser = new CommentChecker(new java.io.FileInputStream(args[0]));
      ...
      System.out.println("         java CommentChecker < inputfile");
  ...
  final public void MissingCommentWarning(String kind) throws ParseException {
 Token t;
        if (blockComment)
                {if (true) return;}
        int i = 0;
  ...
  final public void CompilationUnit() throws ParseException {
    if (jj_2_1(2147483647)) {
                if (blockComment==false){
                        Out("Warning at line 1: ");
                        Out("Adding/using block comment to add information about this file - ");
                        Out("  Author, Copyright, Discription,...\u005cn");
                        warnings.add(new WarningComment(
                new Position(1, 0, 0, 0),
                new String[] {WarningComment.BEGIN}));
                }
      PackageDeclaration();
    } else {
      ;
 ...
 */
  final public void RUNSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT &&
                    ((MyCommentToken)getToken(1)).realKind == RUNSIGNEDSHIFT) {
  ...
  final public void RSIGNEDSHIFT() throws ParseException {
    if (getToken(1).kind == GT &&
                    ((MyCommentToken)getToken(1)).realKind == RSIGNEDSHIFT) {
